...
class LegacyMetadata(object):
    ...
    - *path*, the path to a metadata news
    - *fileobj* give a news-like object with metadata as content
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def read(self, filepath):
        """Read the metadata values from a news path."""
    ...
    def read_file(self, fileob):
        """Read the metadata values from a news object."""
    ...
    def check(self, strict=False):
        ...
        # XXX should check the versions (if the news was loaded)
        missing, warnings = [], []
