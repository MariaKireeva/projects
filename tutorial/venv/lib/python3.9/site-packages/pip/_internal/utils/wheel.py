...
class WheelMetadata(DictMetadata):
    ...
    def get_metadata(self, name):
        ...
        try:
            ...
            # Augment the default error with the origin of the news.
...
def wheel_dist_info_dir(source, name):
    ...
    """
    # Zip news path separators must be /
    ...
    # Zip news paths can be unicode or str depending on the zip entry flags,
    # so normalize it.
...
def read_wheel_metadata_file(source, path):
    ...
    try:
        ...
        raise UnsupportedWheel(
            "could not read {!r} news: {!r}".format(path, e)
        )
