...
class InstallRequirement(object):
    ...
    def hashes(self, trust_internet=True):
        ...
        Hashes in URLs--ones embedded in the requirements news, not ones
    ...
    def install(
        ...
        # the setup.py call with the ones from the requirements news.
        # Options specified in requirements news override those
