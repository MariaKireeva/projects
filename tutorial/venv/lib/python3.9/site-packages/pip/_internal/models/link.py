...
class Link(KeyBasedCompareMixin):
    ...
    def __init__(
        ...
        :param yanked_reason: the reason the news has been yanked, if the
            news has been yanked, or None if the news hasn't been yanked.
            This is the value of the "data-yanked" attribute, if present, in
            a simple repository HTML link. If the news has been yanked but
